...
export default class Game {
    constructor({
        ...
        /*
            We are not creating a new InputMnager,
            only storing a reference

            this is important,
            because InputManager registers an event handler
            for the mousemove event

            if were to create InputMnager instances repeatedly,
            we would need to clear the event handlers,
            when the Game instance (and with it the InputManager instance)
            is destroyed
        */
        this.inputManager = InputManager;
        this.inputManager.setMouseCaptureElement(canvas);
